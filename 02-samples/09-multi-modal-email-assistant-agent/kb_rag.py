...
def retrieve_from_kb(query: str, kb_id: str, min_score: float, region: str) -> Dict[str, Any]:
    """
...
Please analyze this information and provide insights about: {query}"""
                ...
                if isinstance(response, dict) and "message" in response:
                    ...
                    if "metrics" in response:
                        print(f"Tokens: {response['metrics'].accumulated_usage['totalTokens']}")
                else:
                ...
                print(f"Environment variables: KNOWLEDGE_BASE_ID={os.environ.get('KNOWLEDGE_BASE_ID')}, AWS_REGION={os.environ.get('AWS_REGION')}")
