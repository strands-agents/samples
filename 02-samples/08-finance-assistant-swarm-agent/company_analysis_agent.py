...
import urllib.parse
from typing import Dict, Any, Union, Set, Annotated, Optional
            ...
            if news_data and len(news_data) > 0:
                for item in news_data[:5]:
                    news_item = {
                        ...
                        'date': dt.datetime.fromtimestamp(item.get('providerPublishTime', 0)).strftime('%Y-%m-%d')
                    }
        ...
        if len(all_news) < 5:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    for article in articles[:5]:
                        title_elem = article.select_one('a[data-test-id="post-list-item-title"]')
        ...
        if len(all_news) < 5:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    news_elements = []
                    selectors = [
                        'div.SoaBEf', 'div.dbsr', 'g-card', '.WlydOe', '.ftSUBd'
                    ]
                    ...
                    if not news_elements:
                        ...
                        for link in all_links:
                            href = link.get('href', '')
                            if 'news' in href.lower() and link.text and len(link.text.strip()) > 20:
...
def create_initial_messages():
    ...
    return [{
        ...
        "role": "assistant",
        "content": [{"text": "I'm ready to help you analyze a company. Please provide a ticker symbol."}]
    }]
...
def main():
    ...
    while True:
        ...
        try:
            ...
            user_message = {
                "role": "user",
                "content": [{"text": f"Please provide a comprehensive analysis for: {query}"}]
            }
