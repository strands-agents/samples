...
def main():
    ...
    print("This assistant can process medical documents (PDFs or images) to extract and enrich medical information.")
    print("It will identify diagnoses, medications, and treatments, and link them to standardized medical codes.")
    ...
    while True:
        ...
        if choice == "1":
            ...
            response = medical_agent(f"Process this clinical note and extract diagnoses, medications, and treatments with their respective medical codes: {clinical_note}")
            print("\nProcessing complete!")
