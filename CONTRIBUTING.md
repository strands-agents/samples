...
4. For new samples, follow the project structure guidelines in [`_templates/02-samples/structure.md`](_templates/02-samples/structure.md) and use the README template in [`_templates/02-samples/readme.md`](_templates/02-samples/readme.md).
