...
| [`04-use-cases`](./04-use-cases/) | **See agents in action.** Industry-specific applications organized by domain: finance, healthcare, retail, and more |
| [`05-techniques`](./05-techniques/) | **Apply architectural patterns.** Reusable design patterns for retrieval, reasoning, and agent coordination |
...
3. **Building for a specific industry?** Browse [`04-use-cases`](./04-use-cases/)
