...
| [`14-session-management`](./14-session-management/) | `SessionManager`, `FileSessionManager`, `S3SessionManager` | Persist agent state across restarts with pluggable backends |
